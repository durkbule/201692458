...
void NSCLASS rreq_tbl_set_max_len(unsigned int max_len) //给路由请求表设置最大值
{
...
void NSCLASS rreq_tbl_timeout(unsigned long data)       //路由请求表超时
{
